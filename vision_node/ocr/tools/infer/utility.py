...
def init_args():
    ...
    parser.add_argument("--vis_font_path", type=str, default="./NotoSansSC-VariableFont_wght.ttf")
...
def create_predictor(args, mode, logger):
    ...
    if args.use_onnx:
        ...
        config.switch_ir_optim(False)  # Disable IR optimization to avoid illegal instruction
...
def draw_box_txt_fine(img_size, box, txt, font_path="./NotoSansSC-VariableFont_wght.ttf"):
    box_height = int(
...
def create_font(txt, sz, font_path="./NotoSansSC-VariableFont_wght.ttf"):
...
def text_visual(
    texts, scores, img_h=400, img_w=600, threshold=0.0, font_path="./NotoSansSC-VariableFont_wght.ttf"
):
    """
